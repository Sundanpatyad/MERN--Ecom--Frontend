...
const { sanitizeUser,  cookieExtractor } = require("./services/comon");
        ...
        try {
            ...
            crypto.pbkdf2(password, user.salt, 310000, 32, 'sha256', async function (err, hashedPassword) {
                ...
                if (!crypto.timingSafeEqual(user.password, hashedPassword)) {
                    ...
                    const token = jwt.sign({ id: user.id, role: user.role }, process.env.JWT_SECRET_KEY); // Generate token here
